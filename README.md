...
It also has LightDM + xfce as a GUI but it's kinda boring to use this awesome retro-looking device with graphical interface. **Let's try to set it up for a serious business and a maximum entertainment without any GUI** - just how it was in the good old days. 
